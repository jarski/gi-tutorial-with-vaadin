...
ub={a:"jsx_dojo",b:"jsx:/../dojo-toolkit",c:"",d:"undefined",e:"/dojo/",f:/rhino|spidermonkey/,g:"browser",h:"/dojo/dojo.js",i:"load",j:'[label="JSXBODY"]',k:"html",l:"fontSize",m:"fontFamily"};j.hub=new
jsx3.util.DojoPubSub();j.getPath=function(n){var
na=jsx3.getEnv(ub.a)||ub.b;return jsx3.resolveURI(na+(n?n:ub.c));};j.load=function(){if(typeof dojo==ub.d){window.djConfig=typeof djConfig==ub.d?{baseUrl:jsx3.util.Dojo.getPath(ub.e),afterOnLoad:true}:djConfig;load=(function(s){jsx3.CLASS_LOADER.loadJSFileSync(s.replace(ub.f,ub.g));});jsx3.CLASS_LOADER.loadJSFileSync(jsx3.util.Dojo.getPath(ub.h));delete load[ub.i];var
Mb=(dojo.query(ub.j))[0];dojo.style((dojo.query(ub.k))[0],{fontSize:dojo.style(Mb,ub.l),fontFamily:dojo.style(Mb,ub.m)});}};j.isLoaded=function(){return typeof dojo!=ub.d;};});
