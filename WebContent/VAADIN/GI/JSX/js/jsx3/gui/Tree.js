...
Nb=false;if(this.Zs(h)){if(f)this.QK(h);}else{this.FF(h);Nb=true;}if(Nb&&!p)this.doEvent(ub.w,{objEVENT:r,strRECORDID:h,strRECORDIDS:[h]});}else{var
...
Fb=jsx3.gui.isMouseEventModKey(q);if(Fb||!this.Zs(J))this.a8(q,J,Fb,Fb);}}else this.wX((this.c8())[0]);}else this.wX((this.c8())[0]);};b.yH=function(){if(this._jsxf2!=null)return this._jsxf2;var
bb=this.c8();if(bb.length==1)return bb[0];return null;};b.lu=function(f,q,c){var
yb=this.getValue();var
ra=false;var
Sa=!jsx3.gui.isMouseEventModKey(f)||!this.Zs(c);var
C=[q];var
...
fb=a.shiftKey()||jsx3.gui.isMouseEventModKey(a);if(this.Zs(Ta))this.wX(Ta);else this.a8(a,Ta,fb,fb);Lb.showContextMenu(a,this,Ta);}}}this.P3(a);};b.Ri=function(o,k){var
...
S=this;if(j.G1)window.clearTimeout(j.G1);j.G1=window.setTimeout(function(){j.G1=null;if(S.getParent()!=null)S.m4(o,Fa,oa,na);},jsx3.EventHelp.SPYDELAY);}};b._ebMouseMove=function(a,r){if(jsx3.EventHelp.isDragging()&&this.getCanDrop()==1){var
...
na=f.toElement();if(!na||na.id!=ub.ra){jsx3.sleep(jsx3.gui.Interactive.hideSpy);this.removeSpyStyle(N);if(j.G1)window.clearTimeout(j.G1);}}};b._ebKeyDown=function(o,e){if(this.jsxsupermix(o,e))return;var
Ya=o.keyCode();var
...
ib=this.Zs(S);if(ib&&o.enterKey()){this.n2(o);}else this.a8(o,S,jsx3.gui.isMouseEventModKey(o)||o.shiftKey(),true);o.cancelAll();}}};b.wq=function(g){var
...
ia=this.getId();var
ib=this.doTransform();if(!ib)ib=this.getNoDataMessage();ib=ib+(ub.Ea+jsx3.gui.Block.SPACE+ub.Fa+this.ri(ub.Aa,ub.Ga)+ub.Ha+this.Rl()+ub.Ia);var
