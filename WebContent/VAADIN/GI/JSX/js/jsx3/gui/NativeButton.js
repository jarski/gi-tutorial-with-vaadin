...
L=jsx3.gui.Form;var
xb=jsx3.gui.Interactive;a.BUTTON=0;a.SUBMIT=1;a.RESET=2;f.getType=function(){return this.jsxtype;};f.setType=function(h){this.jsxtype=h;};f.p8=function(){switch(this.getType()){case 1:return ub.b;case 2:return ub.c;default:return ub.d;}};f.doValidate=function(){this.setValidationState(1);return this.getValidationState();};f.ch=function(){var
...
Jb=this.Wl(true);Jb.setAttributes(ub.p+this.p8()+ub.q+Ga+ub.r+this.bc()+this.Zj()+this.Rl()+this.paintValue()+this.nk()+Ea+ub.s+this.dd()+ub.t+Ta);Jb.setStyles(Da);return (Jb.paint()).join(ub.g);};f.nj=function(b,k){this.doEvent(ub.u,{objEVENT:b});};f.dd=function(){var
