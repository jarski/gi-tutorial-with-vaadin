...
K=this.Wl(true);K.setAttributes(ub.J+this.getId()+ub.K+this.Rl()+this.nk()+this.Ak()+pb+ub.L+U);K.setStyles(this.mi(true)+Bb+Va+ja+this.Wi()+this.Bg());var
Xa=K.lg(0);Xa.setStyles(cb!=null?ub.H+cb+ub.I+B:ub.f);Xa.setAttributes(ub.M+jsx3.html.Mf);var
G=K.lg(1);G.setAttributes(ub.N+jsx3.html.Mf);var
