...
K=this.getSrc();var
ya=this.getId();var
Lb=this.getIFrameId();K=K?ub.d+(this.getUriResolver()).resolveURI(K)+ub.e:ub.f;return ub.g+ya+ub.h+this.ad()+this.lc()+this.Bg()+ub.e+this.renderAttributes()+ub.i+ub.j+Lb+ub.k+Lb+ub.l+K+this.Wq()+this.ri(ub.m,ub.n,1)+ub.o+ub.p;};s.getIFrameId=function(){return this.getId()+ub.q;};s.getIFrame=function(){try{return this.eval(this.getIFrameId());}catch(Kb){return null;}};s.getContentDocument=function(){try{var
...
oa=this.getIFrame();if(oa&&oa.setAttribute)oa.setAttribute(ub.t,(this.getUriResolver()).resolveURI(g));else this.repaint();}return this;};s.getScrolling=function(){return this.jsxscroll;};s.setScrolling=function(f){this.jsxscroll=f;return this;};s.Wq=function(){var
