...
Da=X.lg(0);var
_=Da.lg(0);_.setAttributes(this.bc()+ub.W+this.RY()+ub.X+this.Rl()+this.nk()+this.Ak()+this.Zj()+ia);_.setStyles(this._k()+this.jc()+this.wk()+this.Pb()+this.cd()+(G!=null?ub.Y+G+ub.Z:ub.x)+(this.getBackground()!=null?this.getBackground()+ub.Z:ub.x));var
Za=Da.lg(1);Za.setAttributes(ub._+this.ri(ub.A,ub.aa,2));Za.setStyles(ub.ba+this.getIcon(f.w1)+ub.ca);return (X.paint()).join((Da.paint()).join((_.paint()).join(ub.x)+(Za.paint()).join(ub.da)+ub.da));};g.g3=function(d,k){var
rb=this.getId();var
ea=ub.L+rb+ub.M;var
S=ub.ea;var
C=ub.fa;var
hb=this.Rl();return ub.ga+hb+ub.ha+this.ri(ub.P,ub.ia)+this.ri(ub.z,ub.ia)+ub.ja+ub.ka+ub.la+ub.ma+hb+ub.na+rb+ub.oa+ea+ub.pa+S+ub.qa+f.IMAGE_PREVIOUS+ub.ra+this.Nk(ub.sa,f)+ub.ta+ub.ua+d+ub.va+ub.wa+hb+ub.na+rb+ub.xa+ea+ub.pa+S+ub.ya+f.IMAGE_NEXT+ub.ra+this.Nk(ub.za,f)+ub.ta+ub.Aa+ub.Ba+ub.ma+hb+ub.na+rb+ub.Ca+ea+ub.pa+C+ub.qa+f.IMAGE_PREVIOUS+ub.ra+this.Nk(ub.Da,f)+ub.ta+ub.ua+this.d1(k)+ub.va+ub.wa+hb+ub.na+rb+ub.Ea+ea+ub.pa+C+ub.ya+f.IMAGE_NEXT+ub.ra+this.Nk(ub.Fa,f)+ub.ta+ub.Aa+ub.Ga+this.NG(d,k)+ub.Ha+ub.Ia;};g.getIcon=function(q){return !jsx3.util.strEmpty(this.jsxicon)?(this.getServer()).resolveURI(this.jsxicon):q;};g.setIcon=function(h){this.jsxicon=h;};f.GN=function(d){var
