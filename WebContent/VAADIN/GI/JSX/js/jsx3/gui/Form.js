...
Ea=this.getColor();return Ea?ub.i+Ea+ub.g:ub.h;}else return ub.i+(this.getDisabledColor()?this.getDisabledColor():p.DEFAULTDISABLEDCOLOR)+ub.g;};c.Zj=function(){return this.getEnabled()==1?ub.h:ub.j;};c.Rl=function(){return jsx3.gui.Block.prototype.Rl.call(this,this.getIndex()||Number(0));};c.mi=function(j){var
P=this.getCursor();if(!P&&j)P=this.getEnabled()==1?ub.k:ub.l;return P?ub.m+P+ub.g:ub.h;};c.bc=function(){var
