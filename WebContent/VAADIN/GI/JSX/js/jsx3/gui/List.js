...
Ja=this.getId();var
K=ub.D;var
ka=ub.Ja+this.ri(ub.Ia,ub.Ka,1)+ub.La+Ja+ub.Ma+m.RESIZEBARBGCOLOR+ub.Na;var
Pa=this.getHeaderHeight()!=null?this.getHeaderHeight():m.DEFAULTHEADERHEIGHT;var
ra=ub.Oa+Ja+ub.Pa+ub.Qa+ub.D+this.lc()+this.ad()+this.Mm()+this.ch()+this.ke()+ub.Ra+this.Ak()+this.renderAttributes()+ub.Sa;ra=ra+ub.Ta;if(Pa>0){ra=ra+(ub.Ua+Pa+ub.Va);ra=ra+(ub.Oa+Ja+ub.Wa+this.qm()+this.Bn()+ub.Xa);ra=ra+this.Mj();ra=ra+ub.Ya;ra=ra+(ub.Oa+Ja+ub.Za+ub._a);ra=ra+ub.ab;K=ub.bb;}var
Da=this.qj(m.yg,5);var
rb=Ra.parentheight-Pa;ra=ra+(ub.Ua+(Pa==0?ub.J:rb)+ub.cb+rb+ub.w+ub.Xa);ra=ra+(ub.Oa+Ja+ub.db+Da+K+ub.eb+this.ch()+this.getBorder()+ub.fb+rb+ub.w+ub.gb);ra=ra+this.Zg();ra=ra+this.Vk();ra=ra+ub.Ya;ra=ra+ub.ab;ra=ra+ub.hb;ra=ra+ka;ra=ra+ub.Ya;return ra;};o.ch=function(){return ub.ib+(this.getBackgroundColor()?this.getBackgroundColor():m.DEFAULTBACKGROUNDCOLOR)+ub.jb;};o.ke=function(){return this.getBackground()?this.getBackground()+ub.jb:ub.D;};o.qm=function(){return ub.ib+(this.getBackgroundColorHead()?this.getBackgroundColorHead():m.DEFAULTBACKGROUNDCOLORHEAD)+ub.jb;};o.Bn=function(){return this.getBackgroundHead()?this.getBackgroundHead()+ub.jb:m.DEFAULTBACKGROUNDHEAD;};o.dd=function(){return this.getClassName()?this.getClassName():m.DEFAULTROWCLASS;};o.zl=function(){return ub.kb+(this.getHeaderHeight()?this.getHeaderHeight():m.DEFAULTHEADERHEIGHT)+ub.lb;};o.Vk=function(){return ub.D;};o.Mj=function(){var
