...
ha=null;ha=this.jsxxslid;return ha||this.getId()+xb.D;};e.setXSLId=function(d){this.jsxxslid=d;return this;};e.getXSLString=function(){return this.jsxxsl;};e.setXSLString=function(n){this.jsxxsl=n;return this;};e.getXSLURL=function(){return this.jsxxslurl;};e.setXSLURL=function(j){this.jsxxslurl=j;return this;};e.getXMLTransformers=function(){return this.jsxxmltrans!=null?this.jsxxmltrans.split(xb.E):[];};e.setXMLTransformers=function(r){this.jsxxmltrans=r!=null?jsx3.$A.is(r)?r.join(xb.F):r:null;};e.fw=function(a){var
