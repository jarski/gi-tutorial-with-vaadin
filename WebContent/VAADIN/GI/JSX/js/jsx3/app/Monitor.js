...
Ta=jsx3.app.Server;b.F0=false;b.Np=jsx3.net.URIResolver.DEFAULT.resolveURI(jsx3.getEnv(ub.a)||ub.b);b.ideDidLoad=function(){b.F0=true;};o.VH=false;o.n5=true;o.YF=null;o.Gx=false;o.HC=null;o.Jo=null;o.init=function(c){this.jsxsuper(c);};o.onAfterInit=function(){if(this.YF!=null){var
sa=null;if(jsx3.Class.forName(ub.c))sa=jsx3.System.getApp(this.YF);if(sa!=null){this.MO(sa);}else Ta.subscribe(Ta.INITED,this,ub.d);}else{this.n5=false;this.Gx=false;this.VH=true;this.bI();}};o.MO=function(p){this.VH=true;this.HC=p;if(this.Gx){var
