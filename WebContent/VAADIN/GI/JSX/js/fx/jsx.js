...
k(window.event,p):null;};a.zB=function(){try{if(this.yq==null)return this._clone;else if(this.yq.currentTarget!=null)return this.yq;}catch(Kb){}this.yq=null;return this._clone;};a.event=function(){return this.zB();};a.getType=function(){return (this.zB()).type;};a.srcElement=function(){var
Qa=this.zB();return Qa.target||Qa.srcElement;};a.toElement=function(){var
hb=this.zB();return hb.type==ub.n?hb.relatedTarget:hb.target;};a.fromElement=function(){var
xb=this.zB();return xb.type==ub.o?xb.relatedTarget:xb.target;};a.isMouseEvent=function(){var
...
Ha=this.zB();return Ha.keyCode;};a.clientX=function(){var
z=this.zB();return z?z.clientX:Number.NaN;};a.clientY=function(){var
Kb=this.zB();return Kb?Kb.clientY:Number.NaN;};a.getOffsetX=function(){var
Db=(this.zB()).target;var
Fb=(this.zB()).clientX;return Fb-(jsx3.html.getRelativePosition(Db.ownerDocument.body,Db)).L;};a.getOffsetY=function(){var
Bb=(this.zB()).target;var
Xa=(this.zB()).clientY;return Xa-(jsx3.html.getRelativePosition(Bb.ownerDocument.body,Bb)).T;};a.getScreenX=function(){return (this.zB()).screenX;};a.getScreenY=function(){return (this.zB()).screenY;};a.getTrueX=function(){return (this.zB()).clientX;};a.getTrueY=function(){return (this.zB()).clientY;};a.getWheelDelta=function(){var
Ra=-1*Math.ceil((this.zB()).detail/3);return Ra;};a.shiftKey=function(){var
Z=this.zB();return Z.shiftKey;};a.ctrlKey=function(){var
Va=this.zB();return Va.ctrlKey;};a.altKey=function(){var
C=this.zB();return C.altKey;};a.metaKey=function(){var
Kb=this.zB();return Kb.metaKey;};a.enterKey=function(){return (this.zB()).keyCode==13;};a.spaceKey=function(){return (this.zB()).keyCode==32;};a.tabKey=function(){return (this.zB()).keyCode==9;};a.rightArrow=function(){return (this.zB()).keyCode==39;};a.leftArrow=function(){return (this.zB()).keyCode==37;};a.upArrow=function(){return (this.zB()).keyCode==38;};a.downArrow=function(){return (this.zB()).keyCode==40;};a.deleteKey=function(){return (this.zB()).keyCode==46;};a.backspaceKey=function(){return (this.zB()).keyCode==8;};a.insertKey=function(){return (this.zB()).keyCode==45;};a.homeKey=function(){return (this.zB()).keyCode==36;};a.endKey=function(){return (this.zB()).keyCode==35;};a.pageUpKey=function(){return (this.zB()).keyCode==33;};a.pageDownKey=function(){return (this.zB()).keyCode==34;};a.escapeKey=function(){return (this.zB()).keyCode==27;};a.exists=function(){return this.zB()!=null;};a.cancelBubble=function(){var
I=this.zB();I._jsxAt=true;if(!I._jsxky)I.stopPropagation();};a.cancelReturn=function(){(this.zB()).returnValue=false;};a.preventDefault=function(){var
Kb=this.zB();if(!Kb._jsxky)Kb.preventDefault();};a.cancelKey=function(){var
w=this.zB();if(!w._jsxky){w.stopPropagation();w.preventDefault();}};a.cancelAll=function(){this.cancelBubble();this.cancelKey();this.cancelReturn();};a.leftButton=function(){var
G=this.zB();if(jsx3.app.Browser.macosx&&G.ctrlKey)return false;var
...
Ma=this.zB();return Ma.button;};a.setReturn=function(i){(this.zB()).returnValue=i;};a.setKeyCode=function(o){var
ja=this.zB();if(ja.charCode==13){var
...
Ab=this.zB();return Ab.keyCode==16||Ab.keyCode==17||Ab.keyCode==18||Ab.keyCode==224;};a.hasModifier=function(h){return !h&&this.shiftKey()||this.ctrlKey()||this.altKey()||this.metaKey();};a.isArrowKey=function(){var
ab=this.keyCode();return ab>=37&&ab<=40;};a.isFunctionKey=function(){var
qb=this.keyCode();return qb>=112&&qb<=126;};a.getAttribute=function(e){return (this.zB())[e];};a.setAttribute=function(n,h){(this.zB())[n]=h;};a.removeAttribute=function(q){(this.zB())[q]=null;};k.dispatchMouseEvent=function(j,g,i){var
...
na=this.zB();if(na==null)return ub.ha;var
...
wa=this.bW.attributes;var
U=new
Array(wa.length);for(var
Ab=0;Ab<U.length;Ab++)U[Ab]=wa[Ab].nodeName;return U;};a.getRootNode=function(){return this.bW?new
...
m.ChildIterator(this.bW?this.bW.childNodes:[],k);};a.getChildNodes=function(h){if(!this.bW)return new
m.List([]);var
db=this.bW.childNodes;var
Ua=[];for(var
Y=0;Y<db.length;Y++){var
Ca=db[Y];if(Ca.nodeType==1||h&&(Ca.nodeType==3||Ca.nodeType==4))Ua[Ua.length]=Ca;}return new
m.List(Ua);};a.removeChild=function(g){var
db=g.getParent();return db!=null&&db.equals(this)?new
m(this.bW.removeChild(g.bW)):null;};a.removeChildren=function(){var
na=this.bW.childNodes;for(var
fb=na.length-1;fb>=0;fb--)this.bW.removeChild(na[fb]);};a.removeAttribute=function(n){if(this.fA==1)this.bW.removeAttribute(n);};a.removeAttributeNode=function(j){this.bW.removeAttributeNode(j.bW);return this;};a.equals=function(k){return k!=null&&k.bW==this.bW;};a.getNodeType=function(){return this.fA;};a.getNodeName=function(){return this.bW.nodeName;};a.getNamespaceURI=function(){var
_a=this.bW.namespaceURI;if(_a==null)_a=ub.b;return _a;};a.selectSingleNode=function(f,k){if(!this.bW)return null;return this.rt(f,k,0);};a.selectNodes=function(b,j){if(!this.bW)return new
m.List([]);return this.rt(b,j,1);};a.selectNodeIterator=function(c,i){if(!this.bW)return new
m.SelectIterator();return this.rt(c,i,2);};a.getBaseName=function(){var
Xa=this.getNodeName();var
ka=Xa.indexOf(ub.f);return ka>=0?Xa.substring(ka+1):Xa;};a.getPrefix=function(){var
Fa=this.getNodeName();var
v=Fa.indexOf(ub.f);return v>=0?Fa.substring(0,v):ub.b;};a.getXML=function(){return this.toString();};a.toString=function(){var
na=ub.g+(this.getClass()).getName();if(this.bW!=null&&!this.hasError()){if(this.getNodeType()==2){return this.getNodeName()+ub.h+this.getValue()+ub.i;}else return (new
XMLSerializer()).serializeToString(this.bW);}else return this.hasError()?jsx3._msg(ub.j,na,this.getError()):jsx3._msg(ub.k,na);};a.getValue=function(){if(this.fA==1){var
pb=new
Array(this.bW.childNodes.length);for(var
db=0;db<this.bW.childNodes.length;db++){var
Pa=this.bW.childNodes[db];if(Pa.nodeType==3||Pa.nodeType==4)pb[db]=Pa.nodeValue;else pb[db]=Pa.textContent;}return pb.join(ub.b);}else return this.bW.nodeValue;};a.setValue=function(b){if(b==null)b=ub.b;if(this.fA==1){this.removeChildren();this.appendChild(this.createNode(3,b));}else this.bW.nodeValue=b;return this;};m.qU=new
XPathEvaluator();m.Iz=[XPathResult.FIRST_ORDERED_NODE_TYPE,XPathResult.ORDERED_NODE_ITERATOR_TYPE,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE];a.rt=function(o,p,f){if(typeof p==ub.l)p=jsx3.xml.Document.yc(p);var
nb=this.bW.ownerDocument;var
ma=nb.documentElement;var
da=p?m.gs(p,ma):m.C7(nb)||m.qU.createNSResolver(ma);var
ba=null;try{ba=m.qU.evaluate(o,this.bW,da,m.Iz[f],null);}catch(Kb){}if(f==1){var
Za=null;var
y=[];if(ba)while(Za=ba.iterateNext())y[y.length]=Za;return new
m.List(y);}else if(f==2){return new
m.SelectIterator(ba);}else return ba&&ba.singleNodeValue?new
m(ba.singleNodeValue):null;};m.C7=function(q){if(!q._jsxif)if(q._jsxPk)q._jsxif=m.gs(q._jsxPk);return q._jsxif;};m.jp={};m.gs=function(d){var
P=m.jp[d];if(!P){var
z=(new
DOMParser()).parseFromString(ub.m+d+ub.n,ub.o);P=m.jp[d]=m.qU.createNSResolver(z.documentElement);}return P;};a.fx=function(s){if(s==null){return this.bW.ownerDocument;}else if(s==1){var
Eb=this.bW.ownerDocument;return Eb!=null?Eb.documentElement:null;}else if(s==2)return this.bW.documentElement;};a.getNative=function(){return this.bW;};a.getFirstChild=function(){if(this.fA==1){var
F=this.bW.firstChild;while(F!=null&&F.nodeType!=1)F=F.nextSibling;if(F!=null)return new
m(F);}return null;};a.getLastChild=function(){if(this.fA==1){var
...
Wa=this.bW.previousSibling;while(Wa!=null&&Wa.nodeType!=1)Wa=Wa.previousSibling;if(Wa!=null)return new
m(Wa);}return null;};a.getNextSibling=function(){if(this.fA==1){var
va=this.bW.nextSibling;while(va!=null&&va.nodeType!=1)va=va.nextSibling;if(va!=null)return new
m(va);}return null;};a.transformNode=function(o,e,c){jsx3.require(ub.p);var
ja=new
jsx3.xml.Template(o);if(e)ja.setParams(e);return ja[c?ub.q:ub.r](this);};m.SG=function(){};m.SG.prototype.toString=function(){return ub.s+this.code+ub.t+(typeof this.description!=ub.u?ub.v+this.description:ub.b);};a.Dk=function(h,d){if(this.dN==null)this.dN=new
m.SG();this.dN.code=h;this.dN.description=d;};a.getError=function(){if(!this.dN)this.Dk(0);return this.dN;};a.hasError=function(){return this.dN!=null&&this.dN.code!=0;};a.getOwnerDocument=function(){return this.bW?new
jsx3.xml.Document(this.fx()):null;};m.getVersion=function(){return ub.w;};});jsx3.Entity=jsx3.xml.Entity;jsx3.Class.defineClass("jsx3.xml.Entity.List",jsx3.util.List,null,function(d,e){var
ub={a:"Not implemented",b:"[",c:"]"};var
Xa=jsx3.Exception;e.init=function(s){this.jsxsuper(null,true);this.wC=s;};e.get=function(i){var
Ja=this.wC[i];return Ja!=null?new
jsx3.xml.Entity(Ja):Ja;};var
na=ub.a;e.add=function(){throw new
Xa(na);};e.addAll=function(){throw new
Xa(na);};e.set=function(){throw new
Xa(na);};e.remove=function(){throw new
Xa(na);};e.removeAt=function(){throw new
Xa(na);};e.sort=function(){throw new
Xa(na);};e.slice=function(c,j){return new
d(arguments.length>1?this.wC.slice(c,j):this.wC.slice(c));};e.toString=function(){return ub.b+this.toArray()+ub.c;};e.clone=function(){return new
d(this.wC.concat());};e.toArray=function(){var
da=this.size();var
ya=new
Array(da);for(var
O=0;O<da;O++)ya[O]=this.get(O);return ya;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(l,p){p.init=function(g,b){this.Ks=g;this.ty=0;this.BJ=b;this.cS();this.bW=null;};p.next=function(){if(!this._next)return null;if(this.bW){this.bW.init(this._next);}else this.bW=new
jsx3.xml.Entity(this._next);this.cS();return this.bW;};p.hasNext=function(){return this._next!=null;};p.cS=function(){this._next=null;var
Aa=this.Ks;var
bb=Aa.length;while(this._next==null&&this.ty<bb){var
fa=Aa[this.ty];if(fa.nodeType==1||this.BJ&&(fa.nodeType==3||fa.nodeType==4))this._next=fa;this.ty++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(g,k){k.init=function(n){this.dY=n;this.w2=0;this.bW=null;};k.next=function(){var
Cb=this.dY.snapshotItem(this.w2++);if(!Cb)return null;if(this.bW){this.bW.init(Cb);}else this.bW=new
jsx3.xml.Entity(Cb);return this.bW;};k.hasNext=function(){return this.dY&&this.w2<this.dY.snapshotLength;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(g,f){var
...
B=ka.getScheme();var
aa=g._HANDLERS[B]||g.jsxclass;return (aa.newInstance()).open(i,ka,d,e,s);};g._HANDLERS={};g.addSchemeHandler=function(a,m){g._HANDLERS[a]=m;};g.getSchemeHandler=function(m){return g._HANDLERS[m];};f.open=function(k,i,b,c,q){this.hS=0;this.bp=Boolean(b);this.yT=k;this.eE=jsx3.net.URIResolver.DEFAULT.resolveURI(i);try{if(window.netscape&&netscape.security&&netscape.security.hasOwnProperty())netscape.security.PrivilegeManager.enablePrivilege(ub.j);}catch(Kb){g.Q2(5,jsx3._msg(ub.k,jsx3.NativeError.wrap(Kb)));}try{g.Q2(6,jsx3._msg(ub.l,this.eE));this._request.open(k,this.eE.toString(),this.bp,c,q);}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.m,i,jsx3.NativeError.wrap(Kb)));}return this;};g.cancelRequest=function(p){var
sb=g.UN[p];if(sb)sb.abort();};g.getRequest=function(h){return g.UN[h];};f.getURL=function(){return this.eE&&this.eE.toString();};f.setTimeouts=function(n,i,d,l){return this;};f.send=function(d,m){if(this.hS==400)throw new
jsx3.Exception(jsx3._msg(ub.n));var
Ma=new
jsx3.util.Timer(g.jsxclass,this.eE);var
B=false;try{if(!this.bp)g.INSYNC=true;this._request.send(d);if(this.bp)this.hS=0;else delete this[ub.o];}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.p,this.eE,jsx3.NativeError.wrap(Kb)));B=this;}finally{g.INSYNC=false;}if(this.bp){if(B||this._request.readyState==4){jsx3.sleep(function(){Ma.log(ub.q);this.publish({subject:ub.a});},null,this);}else{var
...
ub={A:" ",B:"xml.unknown",C:"UniversalBrowserRead",D:"1.0",E:"UTF-8",F:"<?xml",G:' version="',H:'"',I:' encoding="',J:' standalone="',K:"yes",L:"no",M:"?>\n",N:"xml",O:"<!-- ",P:" -->",Q:"\n",R:"XPath",S:"xmlns:",T:"='",U:"'",V:"object",W:"([^=]*)=['\"]([^\"^']*)['\"]",X:"g",Y:":",Z:"http://www.w3.org/XML/1998/namespace",_:"undefined",a:"response",aa:"jsx",b:"error",ba:"attribute::* | child::*",c:"timeout",ca:"3.0.0",d:"http://xsd.tns.tibco.com/gi/cxf/2006",e:"jsx_xmlns",f:/xmlns:([^=]*)=['\"]([^\"^']*)['\"]/g,g:"",h:"xml.parser",i:"MV",j:"GET",k:"*",l:"CY",m:"lw",n:"content-type",o:/xml|xsl/i,p:"xml.doc_status",q:"xml.timeout",r:"text/xml",s:"parse",t:"0",u:"xml.err_fmt",v:"xml.doc_bad_ex",w:"xml.doc_bad",x:"parsererror",y:/^http:\/\/www\.mozilla\.org\/(.+\/)?parsererror.xml/i,z:/[\n\r]/g};var
...
XMLSerializer()).serializeToString(this.MV);}else return this.jsxsuper();};m.getXmlVersion=function(){return this.MV.xmlVersion;};m.getXmlEncoding=function(){return this.MV.xmlEncoding;};m.getXmlStandalone=function(){return this.MV.xmlStandalone;};m.serialize=function(g,j,k){if(g===true)g=this.getXmlVersion()||ub.D;if(j===true)j=this.getXmlEncoding()||ub.E;var
Ja=g||j||k;if(Ja){var
Kb=ub.F;if(g)Kb=Kb+(ub.G+g+ub.H);if(j)Kb=Kb+(ub.I+j+ub.H);if(k!=null)Kb=Kb+(ub.J+(k?ub.K:ub.L)+ub.H);Kb=Kb+ub.M;var
C=new
Array(this.MV.childNodes.length+1);C[0]=Kb;for(var
z=0;z<this.MV.childNodes.length;z++){var
X=this.MV.childNodes[z];if(X.nodeType!=7||X.nodeName!=ub.N){var
Lb=new
Ma(X);C[z+1]=Lb.hasError()?ub.O+Lb+ub.P:Lb.toString();}}}else{var
C=new
Array(this.MV.childNodes.length);for(var
z=0;z<this.MV.childNodes.length;z++){var
X=this.MV.childNodes[z];var
Lb=new
Ma(X);C[z]=Lb.hasError()?ub.O+Lb+ub.P:Lb.toString();if(X.nodeType==7||X.nodeName==ub.N)C[z]+=ub.Q;}}return C.join(ub.g);};m.createDocumentElement=function(p,k){if(k==null)k=null;var
pb=this.MV.createElementNS(k,p);if(this.MV.documentElement!=null)this.MV.replaceChild(pb,this.MV.documentElement);else this.MV.appendChild(pb);this.UX(this.MV.documentElement);return new
jsx3.xml.Entity(pb);};m.createProcessingInstruction=function(b,j){var
ja=this.MV.createProcessingInstruction(b,j);this.MV.appendChild(ja);};m.setAsync=function(q){this._jsxdD=q;return this;};m.getAsync=function(l){return Boolean(this._jsxdD);};m.setSelectionLanguage=function(r){return this;};m.getSelectionLanguage=function(){return ub.R;};e.yc=function(l){var
fa=[];for(var kb in l)fa[fa.length]=ub.S+l[kb]+ub.T+kb+ub.U;return fa.join(ub.A);};m.setSelectionNamespaces=function(a){if(typeof a==ub.V)a=e.yc(a);this.MV._jsxPk=a;this.MV._jsxif=null;return this;};m.getSelectionNamespaces=function(j){return this.MV._jsxPk?this.MV._jsxPk:ub.g;};m.createNamespaceAxis=function(){var
Ha=this.getRootNode();var
La=Ha.toString();var
Aa=ub.g;do{var
Jb=new
RegExp(ub.S+ub.e+Aa+ub.W,ub.X);var
nb=La.search(Jb);if(nb>=0)Aa=Aa==ub.g?0:Aa+1;}while(nb>=0);this.W5(Ha,ub.e+Aa);this.loadXML(this.getXML());return ub.e+Aa;};m.W5=function(a,r){var
qb=(a.cloneNode(false)).getXML();var
Ia;while(Ia=e.lP.exec(qb))if(RegExp.$1!=r&&RegExp.$1!=ub.N){var
Sa=a.createNode(2,r+ub.Y+RegExp.$1,e.SEARCHABLE_NAMESPACE);Sa.setValue(RegExp.$2);a.setAttributeNode(Sa);}else if(RegExp.$1==ub.N)jsx3.log(qb);for(var
wb=a.getChildIterator();wb.hasNext();)this.W5(wb.next(),r);};m.getDeclaredNamespaces=function(g){this._jsxR5={};var
Gb=this.getRootNode();if(Gb)this.yV(Gb,{index:0},g);return this._jsxR5;};m.yV=function(k,a,i){var
xb=k.getNamespaceURI();if(xb!=ub.g&&xb!=ub.Z){var
ua;if(!this._jsxR5[xb]||i&&(ua=k.getPrefix())!=ub.g&&typeof i[ua]!=ub._)if(ua){this._jsxR5[xb]=ua;}else{a.index+=1;this._jsxR5[xb]=ub.aa+a.index;}}if(k.getNodeType()==1)for(var
Eb=k.selectNodeIterator(ub.ba);Eb.hasNext();){var
va=Eb.next();if(va.getNodeType()==1||va.getNodeType()==2)this.yV(va,a,i);}};m.getNativeDocument=function(){return this.MV;};e.Q2=function(d,l){if(e.dK==null)if(jsx3.util.Logger){e.dK=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.dK==null)return;}else return;e.dK.log(d,l);};e.getVersion=function(){return ub.ca;};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){var
...
ub={A:"media",B:"screen",C:"<",D:' xmlns="',E:'"',F:" ",G:'="',H:"/>",I:">",J:"</",K:"<![CDATA[",L:"]]>",M:"&",N:";",O:"<!--",P:"-->",Q:"html.set_outer",R:"beforeend",S:"beforebegin",T:"html.adj",U:"opacity:",V:"jsx:///images/icons/h.png",W:"jsx:///images/icons/v.png",X:"background-image:url(",Y:");",Z:"_jsx_",_:"disable-output-escp",a:"",aa:/&lt;/g,b:"overflow:hidden;",ba:/&gt;/g,c:"body",ca:/&quot;/g,d:'<input type="text" id="_jsx3_html_b1" style="position:absolute;top:0px;left:-120px;width:100px;height:30px;padding:8px;margin:0px;"/>',da:/&amp;/g,e:"beforeEnd",ea:/&([a-zA-Z_]+);/g,f:"_jsx3_html_b1",fa:"class",g:'<div id="_jsx3_html_b2" style="position:absolute;top:0px;left:-116px;width:100px;height:24px;padding:8px;"></div>',ga:/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,h:"_jsx3_html_b2",ha:"&#",i:"string",ia:"jsx_image_loader",j:/^<([^\s]*)([\s\S]*)\/>$/i,ja:"none",k:"<$1$2></$1>",ka:"_",l:"_scrollTop",la:"img",m:"_scrollLeft",ma:"alt",n:"span",na:"id",o:"div",oa:"src",p:/^on/,pa:"unshift",q:"function",qa:"push",r:"event",ra:/\//g,s:"head",sa:/\s+/g,t:"undefined",u:"http://www.w3.org/1999/xhtml",v:"style",w:" {",x:"}",y:"type",z:"text/css"};var
...
Qa,jb,Fa,va;if(!l.getBoundingClientRect){Qa=A.getBoxObjectFor(l);jb=A.getBoxObjectFor(a);Fa=Qa.screenX-jb.screenX+a.scrollLeft;va=Qa.screenY-jb.screenY+a.scrollTop;}else{Qa=l.getBoundingClientRect();jb=a.getBoundingClientRect();Fa=Qa.left-jb.left+Math.max(A.documentElement.scrollLeft,A.body.scrollLeft)-window.scrollX+a.scrollLeft;va=Qa.top-jb.top+Math.max(A.documentElement.scrollTop,A.body.scrollTop)-window.scrollY+a.scrollTop;}return {L:Fa,T:va,W:l.offsetWidth,H:l.offsetHeight};};r.Hy=jsx3.resolveURI(ub.V);r.JW=jsx3.resolveURI(ub.W);r.getCSSFade=function(b){return r.getCSSPNG(b?r.Hy:r.JW);};r.getCSSPNG=function(q){return ub.X+q+ub.Y;};r.getJSXParent=function(s,o){while(s!=null){if(s.id&&s.id.indexOf(ub.Z)==0){var
rb=o?o.getJSXById(s.id):jsx3.GO(s.id);if(rb!=null)return rb;}if(!s.parentNode){var
ca=s.parentWindow||s.defaultView;s=ca?ca.frameElement:null;}else s=s.parentNode;}return null;};r.removeOutputEscaping=function(d){var
wa=d?[d]:[];while(wa.length>0){var
Ga=wa.shift();if(Ga.nodeName&&r._tn(Ga)==ub.n&&Ga.className==ub._){Ga.innerHTML=((((Ga.innerHTML.replace(ub.aa,ub.C)).replace(ub.ba,ub.I)).replace(ub.ca,ub.E)).replace(ub.da,ub.M)).replace(ub.ea,r.V0);Ga.removeAttribute(ub.fa);}else if(Ga.childNodes)wa.push.apply(wa,this.nodesToArray(Ga.childNodes));}};r.removeOutputEscapingSpan=function(j){return j.replace(ub.ga,function(f,e){return ((((e.replace(ub.aa,ub.C)).replace(ub.ba,ub.I)).replace(ub.ca,ub.E)).replace(ub.da,ub.M)).replace(ub.ea,r.V0);});};r.pJ={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.V0=function(f,n){var
Ea=r.pJ[n];return Ea?ub.ha+Ea+ub.N:f;};r.iY=ub.ia;r.loadImages=function(k){var
Pa=document.getElementById(r.iY);if(Pa==null){var
va=(document.getElementsByTagName(ub.c))[0];if(va){Pa=document.createElement(ub.o);Pa.id=r.iY;Pa.style.display=ub.ja;va.insertBefore(Pa,va.firstChild);}else return;}var
ga=jsx3.$A.is(k)?k:arguments;for(var
Cb=0;Cb<ga.length;Cb++){if(!ga[Cb])continue;var
Xa=jsx3.resolveURI(ga[Cb]);var
db=r.iY+ub.ka+Xa;if(document.getElementById(db)==null){var
O=document.createElement(ub.la);O.setAttribute(ub.ma,ub.a);O.setAttribute(ub.na,db);O.setAttribute(ub.oa,ub.a+Xa);Pa.appendChild(O);}}};r.updateRule=function(i,c,b){var
vb=jsx3.html.getRuleByName(i);if(vb)vb.style[c]=b;};r.getElementById=function(l,e,s){return this.findElements(l,function(f){return f.id==e;},s,false,false,true);};r.getElementByTagName=function(j,h,q){h=h.toLowerCase();return this.findElements(j,function(p){return r._tn(p)==h;},q,false,false,true);};r.getElementsByTagName=function(s,q,g){q=q.toLowerCase();return this.findElements(s,function(e){return r._tn(e)==q;},g,true,false,true);};r.findElements=function(j,b,q,h,f,l){var
Ta=q?ub.pa:ub.qa;var
Sa=h?[]:null;var
nb=l?[j]:this.nodesToArray(j.childNodes);while(nb.length>0){var
Za=nb.shift();if(b.call(null,Za))if(h)Sa[Sa.length]=Za;else return Za;if(!f)nb[Ta].apply(nb,this.nodesToArray(Za.childNodes));}return Sa;};r.getElmUpByTagName=function(l,a,e){return r.findElementUp(l,function(o){return r._tn(o)==a;},e);};r.findElementUp=function(a,s,m){var
...
Ib=1,U=arguments;if(arguments.length==2)if(typeof p==ub.i){Ib=0;U=p.split(ub.ra);}else if(jsx3.$A.is(p)){Ib=0;U=p;}var
R=k;for(var
...
Bb=qa.onfocus;qa.onfocus=null;qa.focus();jsx3.sleep(function(){qa.onfocus=Bb;});}else qa.focus();};r.focus=function(e){try{if(e.focus)e.focus();}catch(Kb){}};r.addClass=function(j,c){var
v=j.className;if(v){if(!(jsx3.$A(v.split(ub.sa))).contains(c))j.className=v+ub.F+c;}else j.className=c;};r.removeClass=function(f,j){var
ob=f.className;if(ob&&ob.indexOf(j)>=0){var
ya=jsx3.$A(ob.split(ub.sa));if(ya.remove(j))f.className=ya.join(ub.F);}};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(g,a){var
ub={a:"end"};var
ma=jsx3.html;a.init=function(m){this.mZ={elm:m,start:m.selectionStart,end:m.selectionEnd,scrollt:m.scrollTop,scrolll:m.scrollLeft};};a.getStartIndex=function(){return this.mZ.start;};a.getEndIndex=function(){return this.mZ.end;};a.setRange=function(i,p){this.mZ.start=i;this.mZ.end=p;this.mZ.elm.setSelectionRange(i,p);};a.getOffsetLeft=function(){if(this.mZ.pos==null)this.mZ.pos=jsx3.html.getRelativePosition(null,this.mZ.elm);return this.mZ.pos.L;};a.getOffsetTop=function(){if(this.mZ.pos==null)this.mZ.pos=jsx3.html.getRelativePosition(null,this.mZ.elm);return this.mZ.pos.T;};a.getText=function(){return this.mZ.elm.value.substring(this.mZ.start,this.mZ.end);};a.setText=function(k){this.mZ.elm.value=this.mZ.elm.value.substring(0,this.mZ.start)+k+this.mZ.elm.value.substring(this.mZ.end);this.mZ.elm.setSelectionRange(this.mZ.start,this.mZ.start+k.length);this.mZ.elm.end=this.mZ.elm.selectionEnd;};a.insertCaret=function(f){this.mZ.elm.focus();if(f==ub.a){this.mZ.elm.setSelectionRange(this.mZ.elm.end,this.mZ.elm.end);}else throw new
