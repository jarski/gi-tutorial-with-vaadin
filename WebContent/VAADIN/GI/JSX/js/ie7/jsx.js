...
ub={A:"jsxtabindex",B:"alpha(opacity=",C:")",D:"opacity:",E:";",F:"filter:alpha(opacity=",G:");",H:"text",I:"jsx:///images/icons/h.png",J:"jsx:///images/icons/v.png",K:"background-image:url(",L:"_jsx_",M:"disable-output-escp",N:/&lt;/g,O:"<",P:/&gt;/g,Q:">",R:/&quot;/g,S:'"',T:/&amp;/g,U:"&",V:/&([a-zA-Z_]+);/g,W:"class",X:/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,Y:"&#",Z:"jsx_image_loader",_:"none",a:' unselectable="on"',aa:"_",b:"overflow:hidden;",ba:"img",c:"div",ca:"alt",d:"undefined",da:"id",e:"body",ea:"src",f:'<input type="text" id="_jsx3_html_b1" style="position:absolute;top:0px;left:-120px;width:100px;height:30px;padding:8px;margin:0px;"/>',fa:"unshift",g:"beforeEnd",ga:"push",h:"_jsx3_html_b1",ha:/\//g,i:'<div id="_jsx3_html_b2" style="position:absolute;top:0px;left:-116px;width:100px;height:24px;padding:8px;"></div>',ia:/\s+/g,j:"_jsx3_html_b2",ja:" ",k:"string",l:/^<([^\s]*)([\s\S]*)\/>$/i,m:"<$1$2></$1>",n:"",o:"span",p:"scroll",q:"function",r:/\-(\w)/g,s:"head",t:"http://www.w3.org/1999/xhtml",u:"style",v:"type",w:"text/css",x:"media",y:"screen",z:"object"};var
...
ab=ma.shift();if(ab.nodeName&&r._tn(ab)==ub.o&&ab.className==ub.M){ab.innerHTML=((((ab.innerHTML.replace(ub.N,ub.O)).replace(ub.P,ub.Q)).replace(ub.R,ub.S)).replace(ub.T,ub.U)).replace(ub.V,r.V0);ab.removeAttribute(ub.W);}else if(ab.childNodes)ma.push.apply(ma,this.nodesToArray(ab.childNodes));}};r.removeOutputEscapingSpan=function(g){return g.replace(ub.X,function(b,h){return ((((h.replace(ub.N,ub.O)).replace(ub.P,ub.Q)).replace(ub.R,ub.S)).replace(ub.T,ub.U)).replace(ub.V,r.V0);});};r.pJ={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.V0=function(j,c){var
Za=r.pJ[c];return Za?ub.Y+Za+ub.E:j;};r.iY=ub.Z;r.loadImages=function(p){var
Lb=document.getElementById(r.iY);if(Lb==null){var
nb=(document.getElementsByTagName(ub.e))[0];if(nb){Lb=document.createElement(ub.c);Lb.id=r.iY;Lb.style.display=ub._;nb.insertBefore(Lb,nb.firstChild);}else return;}var
Ma=jsx3.$A.is(p)?p:arguments;for(var
Mb=0;Mb<Ma.length;Mb++){if(!Ma[Mb])continue;var
Cb=jsx3.resolveURI(Ma[Mb]);var
ib=r.iY+ub.aa+Cb;if(document.getElementById(ib)==null){var
Ea=document.createElement(ub.ba);Ea.setAttribute(ub.ca,ub.n);Ea.setAttribute(ub.da,ib);Ea.setAttribute(ub.ea,ub.n+Cb);Lb.appendChild(Ea);}}};r.updateRule=function(f,i,o){var
...
B=1,E=arguments;if(arguments.length==2)if(typeof e==ub.k){B=0;E=e.split(ub.ha);}else if(jsx3.$A.is(e)){B=0;E=e;}var
J=c;for(var
...
Eb=jsx3.html;if(document.documentMode>=11){o.init=function(e){this.mZ={elm:e,start:e.selectionStart,end:e.selectionEnd,scrollt:e.scrollTop,scrolll:e.scrollLeft};};o.getStartIndex=function(){return this.mZ.start;};o.getEndIndex=function(){return this.mZ.end;};o.setRange=function(l,s){this.mZ.start=l;this.mZ.end=s;this.mZ.elm.setSelectionRange(l,s);};o.getOffsetLeft=function(){if(this.mZ.pos==null)this.mZ.pos=jsx3.html.getRelativePosition(null,this.mZ.elm);return this.mZ.pos.L;};o.getOffsetTop=function(){if(this.mZ.pos==null)this.mZ.pos=jsx3.html.getRelativePosition(null,this.mZ.elm);return this.mZ.pos.T;};o.getText=function(){return this.mZ.elm.value.substring(this.mZ.start,this.mZ.end);};o.setText=function(n){this.mZ.elm.value=this.mZ.elm.value.substring(0,this.mZ.start)+n+this.mZ.elm.value.substring(this.mZ.end);this.mZ.elm.setSelectionRange(this.mZ.start,this.mZ.start+n.length);this.mZ.elm.end=this.mZ.elm.selectionEnd;};o.insertCaret=function(g){this.mZ.elm.focus();if(g==ub.a){this.mZ.elm.setSelectionRange(this.mZ.elm.end,this.mZ.elm.end);}else throw new
jsx3.Exception();this.mZ.elm.scrollTop=this.mZ.scrollt;this.mZ.elm.scrollLeft=this.mZ.scrolll;};}else{o.init=function(c){this.mZ=(c.ownerDocument.selection.createRange()).duplicate();this.HD=c;};o.getStartIndex=function(){var
vb=this.HD.ownerDocument.selection.createRange();var
Cb=null;if(Eb._tn(this.HD)==ub.b){Cb=vb.duplicate();Cb.moveToElementText(this.HD);}else Cb=this.HD.createTextRange();Cb.setEndPoint(ub.c,vb);return Cb.text.length-vb.text.length;};o.getEndIndex=function(){var
t=this.HD.ownerDocument.selection.createRange();var
Xa=null;if(Eb._tn(this.HD)==ub.b){Xa=t.duplicate();Xa.moveToElementText(this.HD);}else Xa=this.HD.createTextRange();Xa.setEndPoint(ub.c,t);return Xa.text.length;};o.setRange=function(p,d){var
sb=this.HD.value;var
kb=ub.d;kb.lastIndex=0;var
db=d;while(kb.test(sb)&&kb.lastIndex<=db){p=p-1;d=d-1;}var
oa=this.HD.createTextRange();oa.collapse(true);oa.moveStart(ub.e,p);oa.moveEnd(ub.e,d-p);oa.select();};o.getOffsetLeft=function(){return this.mZ.offsetLeft;};o.getOffsetTop=function(){return this.mZ.offsetTop;};o.getText=function(){return this.mZ.text;};o.setText=function(f){this.mZ.text=f;};o.insertCaret=function(d){if(d==ub.a){this.mZ.collapse();this.mZ.select();}else throw new
