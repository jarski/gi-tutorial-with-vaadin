...
wa=this.S0(Aa[0],Aa[1],bb,la,U,K);I=wa[0];Qa=wa[1];}La.En(Ja,ca,jb,I,Ha,Qa);}La.updateView();rb.appendChild(La.getCanvas());}};d.getVersion=function(){return jsx3.chart.Xe;};});jsx3.Class.defineClass("jsx3.chart.BarChart",jsx3.chart.BCChart,null,function(e,n){n.init=function(l,p,s,d,a){this.jsxsuper(l,p,s,d,a);};n.ql=function(h){return h instanceof jsx3.chart.BarSeries;};n.getXRange=function(o){return this.oX(o);};n.getYRange=function(i){return this.Nr(i);};n.RE=function(){return this.getPrimaryXAxis();};n.tY=function(){return this.getPrimaryYAxis();};});jsx3.Class.defineClass("jsx3.chart.ColumnChart",jsx3.chart.BCChart,null,function(d,a){a.init=function(c,g,j,m,k){this.jsxsuper(c,g,j,m,k);};a.ql=function(q){return q instanceof jsx3.chart.ColumnSeries;};a.getXRange=function(j){return this.Nr(j);};a.getYRange=function(c){return this.oX(c);};a.RE=function(){return this.getPrimaryYAxis();};a.tY=function(){return this.getPrimaryXAxis();};});
