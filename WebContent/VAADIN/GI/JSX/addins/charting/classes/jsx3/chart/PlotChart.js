...
fa=Hb.getMagnitudeValue(Pa);if(fa!=null)Hb.uk(Pa,lb,U,t,fa);}}Hb.updateView();ob.appendChild(Hb.getCanvas());}};d.ql=function(s){return s instanceof jsx3.chart.PlotSeries;};p.getVersion=function(){return jsx3.chart.Xe;};});
