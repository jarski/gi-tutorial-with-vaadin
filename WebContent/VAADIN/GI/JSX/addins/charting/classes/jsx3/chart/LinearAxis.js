...
Eb=Aa+(n.WM-1)*(Aa-bb)/2;B=R*Math.ceil(Eb/R);if(ib!=null)B=B+ib%R;}this.Rf(ub.a,ib);this.Rf(ub.b,B);this.Rf(ub.c,R);return true;};d.Li=function(h){return this.Lm(ub.a)+h*this.Lm(ub.c);};d.jg=function(){var
Ma=this.Lm(ub.b);var
Ya=this.Lm(ub.a);var
W=this.Lm(ub.c);var
Hb=[];var
