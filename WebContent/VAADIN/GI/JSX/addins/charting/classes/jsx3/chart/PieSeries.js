...
G=jsx3.vector;i.GX={top:1,right:1,bottom:1,left:1};h.init=function(q,e){this.jsxsuper(q,e);this.field=null;this.totalAngle=null;this.startAngle=null;this.colors=null;this.colorFunction=null;this.stroke=null;this.labelPlacement=ub.a;this.labelOffset=10;this.setTooltipFunction(ub.b);};h.getTotalAngle=function(){return this.totalAngle;};h.setTotalAngle=function(l){this.totalAngle=l==null?null:Math.max(0,Math.min(360,l));};h.getStartAngle=function(){return this.startAngle;};h.setStartAngle=function(a){this.startAngle=a==null?null:jsx3.util.numMod(a,360);};h.getField=function(){return this.field;};h.setField=function(q){this.field=q;};h.getValue=function(q){if(this.field)return jsx3.chart.asNumber(q.getAttribute(this.field));return null;};h.getColors=function(){return this.colors;};h.setColors=function(a){this.colors=a;};h.getLabelPlacement=function(){return this.labelPlacement!=null?this.labelPlacement:ub.a;};h.setLabelPlacement=function(g){if(i.GX[g]){this.labelPlacement=g;}else throw new
...
H=this.Lm(ub.d);if(H==null){H=[];this.Rf(ub.d,H);}H.push([m,e,d,l,c,q,r,f]);};h.Wm=function(){this.qd(null);};h.Tj=function(){var
T=this.Lm(ub.d);if(T!=null)T.splice(0,T.length);};h.updateView=function(){this.jsxsuper();var
ob=this.getCanvas();var
hb=ob.getWidth();var
Ya=ob.getHeight();var
ba=this.Lm(ub.d);if(ba==null)return;var
