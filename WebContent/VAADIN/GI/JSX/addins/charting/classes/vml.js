...
P=new
jsx3.vector.Fill(f.getColor(),f.getAlpha());P.setType(ub.k);P.setColor2(cb[0]);P.setAngle(cb[1]);P.setAlpha2(cb[2]);P.setColors(cb[3]);return P;}else return f;};n.yd=function(d,g,m){d[g]=m;d[ub.l+g+ub.m]=null;};n.wi=function(g,d,b){if(b==null)b=ub.n;var
db=ub.l+d+ub.m;if(!g[db]&&g[d])try{var
Va=g.eval(ub.o+g[d]+ub.p);g[db]=Va;if(typeof g[db]!=b){n.LOG.error(ub.q+d+ub.r+g[db]+ub.s+b);g[db]=n.t7;}}catch(Kb){Kb=jsx3.NativeError.wrap(Kb);g[db]=n.t7;n.LOG.error(ub.t+b+ub.u+d,Kb);}return g[db]!=n.t7?g[db]:null;};n.Ul=function(l,r){if(typeof l[r]==ub.v)return l[r];return n.wi(l,r,ub.v);};n.Ud=function(q,p){var
...
ub={a:"px",b:"Us",c:"v",d:"urn:schemas-microsoft-com:vml",e:"#default#VML",f:"event",g:"number",h:"#",i:"",j:/^\s*(.*?)\s*$/,k:"$1",l:/[^\d\.]/g,m:/[^\d\.]/,n:" ",o:"on",p:/\"/g,q:"&quot;",r:/;\s*$/,s:";",t:"jsx3.GO('",u:"').",v:"(",w:",this,'",x:"');"};m._e=ub.a;m.BE=ub.b;try{if(document.documentMode>=8){document.namespaces.add(ub.c,ub.d,ub.e);m._IE8=1;}}catch(Kb){}m.Th=ub.c;m.QO=ub.f;m.colorAsHtml=function(d){return typeof d==ub.g?ub.h+((d+16777216).toString(16)).substring(1):ub.i+d;};m.xf=function(g,d,o){if(g==null)g=0;if(d==null)d=ub.a;if(typeof g==ub.g){return g+ub.i+d;}else{g=g.toString();g=g.replace(ub.j,ub.k);if(o)g=g.replace(ub.l,ub.i);return g.match(ub.m)?g:g+ub.i+d;}};m.bm=function(f,e){return m.xf(f,ub.i,true)+ub.n+m.xf(e,ub.i,true);};m.Tb=function(s){return Math.max(0,Math.min(1,s));};m.degreesToRadians=function(d){return jsx3.util.numMod(2*Math.PI/360*(-1*d+90),2*Math.PI);};m.paintEventHandler=function(p,o,g,k){var
Ua=ub.o+o;var
E=ub.i;var
Ja=k.getProperty(Ua);if(Ja){E=Ja.replace(ub.p,ub.q);if(!Ja.match(ub.r))E=E+ub.s;}E=E+(ub.t+p.getId()+ub.u+m.BE+ub.v+m.QO+ub.w+g+ub.x);if(E.length>0)k.setProperty(Ua,E);};m.updateVector=function(i,o){o.outerHTML=i.paint();};});jsx3.Class.defineClass("jsx3.html.Tag",null,null,function(g,q){var
...
ub={a:"group",b:"xmlns:v",c:"urn:schemas-microsoft-com:vml",d:"coordsize",e:"absolute"};a.init=function(m,p,g,q){this.jsxsuper(jsx3.vector.Th,ub.a,m,p,g,q);this.setProperty(ub.b,ub.c);};a.paintUpdate=function(){this.jsxsuper();if(this.getWidth()&&this.getHeight()){this.setProperty(ub.d,jsx3.vector.bm(parseInt(this.getWidth()),parseInt(this.getHeight())));}else this.setProperty(ub.d,jsx3.vector.bm(100,100));if(this.getPosition()!=ub.e){this.setLeft(null);this.setTop(null);}};});jsx3.Class.defineClass("jsx3.vector.Tag",jsx3.html.BlockTag,null,function(j,a){var
...
tb=this.getParent();if(this.getWidth()&&this.getHeight()){this.setProperty(ub.c,jsx3.vector.bm(parseInt(this.getWidth()),parseInt(this.getHeight())));}else this.removeProperty(ub.c);};});jsx3.Class.defineClass("jsx3.vector.Stroke",jsx3.html.Tag,null,function(m,s){var
ub={a:"stroke",b:"<stroke ",c:" ",d:"/>",e:"<",f:":",g:" id='",h:"'",i:" on='",j:" color='",k:" opacity='",l:" weight='",m:/\s+/};var
ga=jsx3.vector;m.dk=ub.a;s.init=function(p,j,h){this.jsxsuper(ga.Th,m.dk);this.VH=null;this.tU=p!=null?p:0;this.Vv=j!=null?j:1;this.jM=h!=null?ga.Tb(h):1;};s.getColor=function(){return this.tU;};s.getColorHtml=function(){return ga.colorAsHtml(this.tU);};s.setColor=function(e){this.tU=e;};s.getWidth=function(){return this.Vv;};s.setWidth=function(n){this.Vv=n;};s.getAlpha=function(){return this.jM;};s.setAlpha=function(p){this.jM=p!=null?ga.Tb(p):null;};s.onAppendChild=function(n){return false;};s.toString=function(){return ub.b+this.getColorHtml()+ub.c+this.Vv+ub.c+this.jM+ub.d;};s.paint=function(){var
...
ga=jsx3.vector;c.dk=ub.a;b.init=function(e,m){this.jsxsuper(ga.Th,c.dk);this.VH=null;this.tU=e!=null?e:0;this.jM=m!=null?ga.Tb(m):1;this.gT=null;this.B9=null;this.B0=null;this.j3=null;this.ZU=null;};b.getColor=function(){return this.tU;};b.getColorHtml=function(){return ga.colorAsHtml(this.tU);};b.setColor=function(s){this.tU=s;};b.getAlpha=function(){return this.jM;};b.setAlpha=function(l){this.jM=l!=null?ga.Tb(l):null;};b.getType=function(){return this.gT;};b.setType=function(g){this.gT=g;};b.getColor2=function(){return this.B9;};b.getColor2Html=function(){return ga.colorAsHtml(this.B9);};b.setColor2=function(n){this.B9=n;};b.getAlpha2=function(){return this.B0;};b.setAlpha2=function(m){this.B0=m;};b.getAngle=function(){return this.j3;};b.setAngle=function(l){this.j3=l;};b.getColors=function(){return this.ZU;};b.setColors=function(l){this.ZU=l;};b.toString=function(){return ub.b+this.getColorHtml()+ub.c+this.getAlpha()+ub.d;};b.paint=function(){var
O=ub.e+ga.Th+ub.f+this.getTagName();if(this.getId()!=null)O=O+(ub.g+this.getId()+ub.h);var
ma=this.getColorHtml();if(this.VH!=null)O=O+(ub.i+this.VH+ub.h);if(ma!=null)O=O+(ub.j+ma+ub.h);if(this.jM!=null&&this.jM<1)O=O+(ub.k+this.jM+ub.h);if(this.gT&&this.gT!=ub.l){O=O+(ub.m+this.gT+ub.h);var
ya=this.getColor2Html();if(ya!=null)O=O+(ub.n+ya+ub.h);if(this.ZU!=null)O=O+(ub.o+this.ZU+ub.h);if(this.j3!=null)O=O+(ub.p+this.j3+ub.h);if(this.B0!=null)O=O+(ub.q+this.B0+ub.h);}O=O+ub.d;return O;};b.zh=function(i,f){i[f]=this.paint();return f+1;};b.Aj=function(){return (this.jM==1||this.jM==null)&&(!this.gT||this.gT==ub.l);};c.valueOf=function(l){if(jsx3.util.strEmpty(l))return null;if(l instanceof c)return l;var
...
ub={a:"path",b:"m 0 0 l ",c:" ",d:"textpath",e:"on",f:"true",g:"textpathok",h:"stroke",i:"false",j:"pv",k:"return jsx3.html.FontTag.prototype.",l:".apply(this.",m:", arguments);",n:"getClassName",o:"setClassName",p:"setExtraStyles",q:"return jsx3.html.Tag.prototype.",r:"",s:"color",t:"v-text-align",u:"string",v:".",w:"#000000",x:"textAlign",y:"filled",z:"stroked"};var
...
v=Math.max(1,Math.max(f,e)-Math.min(f,e));this.jsxsuper(null,r,f,Jb,v);this.setProperty(ub.a,ub.b+(q-r)+ub.c+(e-f));this.pv=new
bb(G.Th,ub.d);this.pv.setProperty(ub.e,ub.f);this.nM=new
bb(G.Th,ub.a);this.nM.setProperty(ub.g,ub.f);this.f0=new
bb(G.Th,ub.h);this.f0.setProperty(ub.e,ub.i);this.setText(a);};var
ab=ub.j;var
...
G.Fill(j));this.pv.setStyle(ub.s,j);};b.getTextAlign=function(){return this.pv.getStyle(ub.t);};b.setTextAlign=function(k){this.pv.setStyle(ub.t,k);};b.getText=function(){return this.pv.getProperty(ub.u);};b.setText=function(s){this.pv.setProperty(ub.u,s);};b.onAppendChild=function(o){var
...
Ca=this.pv.getStyle(ub.x);if(Ca==null){if(Ua==null)Ua=Aa.getStyleClass(ub.v+this.getClassName())||Number(0);if(Ua)Ca=Ua.textAlign;}if(Ca)this.setTextAlign(Ca);}this.jsxsuper();this.setProperty(ub.y,this.getFill()==null?ub.i:ub.f,ub.z,this.getStroke()==null?null:ub.f);if(this.pv.getParent()==null)this.appendChild(this.pv);if(this.nM.getParent()==null)this.appendChild(this.nM);if(this.getStroke()==null){if(this.f0.getParent()==null)this.appendChild(this.f0);}else this.removeChild(this.f0);};});jsx3.Class.defineClass("jsx3.vector.LineGroup",jsx3.vector.Shape,null,function(n,m){var
...
Aa=this.Gl(O,lb);this.gM(ja,Aa,mb,nb);fa=O[lb];}if(fa<this.length){var
Aa=this.Gl(O,O.length);this.gM(ja,Aa,mb,nb);}}var
Ya=this.NM(Eb);var
...
_=lb<ob.length-1?(ob[lb+1]+ob[lb])/2:null;if(_==null&&aa!=null)_=2*ob[lb]-aa;else if(aa==null&&_!=null)aa=2*ob[lb]-_;if(_==null){aa=ob[lb]-50;_=ob[lb]+50;}la=Math.round(_-aa);}else la=this.getDisplayWidth()-this.VV()-this.labelGap;if(this.horizontal){var
...
X=this.Li(j);var
xb=this.getLabelFunction();return xb!=null?xb.apply(this,[X,j]):X!=null?X.toString():ub.l;};q.VV=function(){var
...
v=null,ya=null,Ha=null;switch(yb){case k.BX:case k.PJ:ya=-1;v=-this.labelGap;v=v-Math.max(0,K-o);break;case k.mD:case k.I8:ya=1;v=ab.getLength()+this.labelGap;v=v+Math.max(0,K+o-ab.getLength());break;case k.EJ:case k.Bq:ya=-1;v=o-this.labelGap-K;break;case k.Mq:case k.F8:ya=1;v=o+this.labelGap+K;break;default:ha.LOG.error(ub.u+yb);}if(this.showLabels){if(this.horizontal)Ha=v+ya*k.o4;else Ha=v+ya*this.getDisplayWidth();}else Ha=v;if(this.horizontal&&this.primary||!this.horizontal&&!this.primary){Ha=Math.max(Ha,ab.getLength());}else Ha=Math.min(Ha,0);return [yb,v,ya,K,u,Ha];};q.sl=function(){var
ra=0,Bb=0;var
...
ya=new
L.Rectangle(A,U,ka,aa);ya.setZIndex(n.OG);Nb.appendChild(ya);var
...
hb=this.hG(Ua,ob[Ib].getSeriesName(),this.labelClass,this.labelStyle,O,Math.round(ia+this.boxHeight/2),ra);ia=ia+this.lineHeight;this.Ci(Z,ob[Ib],null);this.Ci(hb,ob[Ib],null);}}else if(Da==2&&nb>0){var
Xa=Ba.bh();var
...
hb=this.hG(Ua,Ra,this.labelClass,this.labelStyle,O,Math.round(ia+this.boxHeight/2),ra);ia=ia+this.lineHeight;this.Ci(Z,null,Ib);this.Ci(hb,null,Ib);}}};q.hG=function(r,d,b,h,c,f,o){var
db=new
...
_=jsx3.vector;var
lb=_.Fill;var
M=jsx3.chart;d.g9=1;d.C8=2;d.ZINDEX_DATA=10;d.Bx=990;d.hC=1000;d.Dy=20;d.DEFAULT_FILLS=[new
lb(3381708,1),new
lb(16763904,1),new
lb(10079334,1),new
lb(13408563,1),new
...
vb=M.splitBox(sb,pb,Ma,zb,this.legendPlacement,U.getPreferredWidth(),U.getPreferredHeight());U.setDimensions(vb[0][0],vb[0][1],vb[0][2],vb[0][3]);U.setZIndex(d.Bx);U.updateView();ra.appendChild(U.getCanvas());G.setDimensions(vb[1][0],vb[1][1],vb[1][2],vb[1][3]);}else G.setDimensions(sb,pb,Ma,zb);var
...
xb=this.getLegend();if(xb!=null)xb.repaint();}};f.onSetChild=function(n){if(M.Legend&&n instanceof M.Legend){if(this.getLegend()!=null){M.LOG.info(ub.j+n+ub.k);return false;}}else if(M.ChartLabel&&n instanceof M.ChartLabel){if(this.getChartTitle()!=null){M.LOG.info(ub.l+n+ub.m);return false;}}else if(M.Series&&n instanceof M.Series){if(!this.ql(n)){M.LOG.info(ub.n+n+ub.o+this);return false;}}else return false;return true;};f.redrawRecord=function(){this.repaint();};f.onXmlBinding=function(j){this.jsxsupermix(j);this.repaint();};d.getVersion=function(){return M.Xe;};});jsx3.require("jsx3.chart.Chart","jsx3.chart.Axis","jsx3.chart.GridLines");jsx3.Class.defineClass("jsx3.chart.CartesianChart",jsx3.chart.Chart,null,function(g,b){var
ub={a:"series",b:"no data provider for chart: "};var
va=jsx3.chart;var
Za=va.Chart;var
Ta=va.GridLines;var
qa=va.Axis;g.oz=function(k){return k instanceof qa&&k.uf()&&k.getHorizontal();};g.Es=function(e){return e instanceof qa&&!e.uf()&&e.getHorizontal();};g.TM=function(l){return l instanceof qa&&l.uf()&&!l.getHorizontal();};g.PE=function(q){return q instanceof qa&&!q.uf()&&!q.getHorizontal();};g.Yt=Za.ZINDEX_DATA+1;g.pU=Za.ZINDEX_DATA+90;g.PT=Za.ZINDEX_DATA+100;g.PART_GRIDLINES=1<<8;b.init=function(l,p,s,d,a){this.jsxsuper(l,p,s,d,a);};b.getGridLines=function(){return Ta?this.getDescendantsOfType(Ta):[];};b.pe=function(h,q){var
v=[];var
...
E=this.zf();for(var
ja=0;ja<E.length;ja++)E[ja].setDimensions(D);};b.bR=function(l,k){if(l!=null){l.setLength(k);l.Ob();}};b.z3=function(q,i,j){var
kb=this.wf();if(q!=null){q.setDimensions(i,j,kb.getWidth(),kb.getHeight());q.setZIndex(g.PT);q.updateView();kb.appendChild(q.getCanvas());}};b.ZS=function(e,q,k,r){var
...
S=Ja[pa];if(S.getDisplay()==jsx3.gui.Block.DISPLAYNONE)continue;S.setZIndex(S.getInForeground()?g.pU:g.Yt);S.repaint();}}this.jsxsuper(m);};b.onSetChild=function(a){if(Ta&&a instanceof Ta){return true;}else if(qa&&a instanceof qa){return true;}else return this.jsxsuper(a);};g.getVersion=function(){return va.Xe;};});