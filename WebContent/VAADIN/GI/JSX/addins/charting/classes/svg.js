...
ub={A:"(",B:",this,'",C:"');",a:"px",b:"Us",c:"http://www.w3.org/2000/svg",d:"evt",e:"number",f:"#",g:"",h:/^\s*(.*?)\s*$/,i:"$1",j:/[^\d\.]/g,k:/[^\d\.]/,l:"on",m:"_",n:"onclick",o:"if(this.getAttribute('_click')) { jsx3.GO('",p:"').",q:"(evt,this,this.getAttribute('_click')); }",r:"if(evt.detail%2==0){if(this.getAttribute('_dblclick'))jsx3.GO('",s:"(evt,this,this.getAttribute('_dblclick'));}",t:"else{if(this.getAttribute('_click'))",u:"jsx3.GO('",v:"(evt,this,this.getAttribute('_click'));}",w:/\"/g,x:"&quot;",y:/;\s*$/,z:";"};m._e=ub.a;m.BE=ub.b;m.Th=ub.c;m.QO=ub.d;m.colorAsHtml=function(a){return typeof a==ub.e?ub.f+((a+16777216).toString(16)).substring(1):ub.g+a;};m.xf=function(a,j,i){if(a==null)a=0;if(j==null)j=ub.a;if(typeof a==ub.e){return a+ub.g+j;}else{a=a.toString();a=a.replace(ub.h,ub.i);if(i)a=a.replace(ub.j,ub.g);return a.match(ub.k)?a:a+ub.g+j;}};m.Tb=function(s){return Math.max(0,Math.min(1,s));};m.degreesToRadians=function(b){return jsx3.util.numMod(2*Math.PI/360*(-1*b+90),2*Math.PI);};m.paintEventHandler=function(o,n,f,j){var
Ta=ub.l+n;var
Eb=ub.g;if(n==jsx3.gui.Event.DOUBLECLICK||n==jsx3.gui.Event.CLICK){j.setProperty(ub.m+n,f);var
Kb=j.getProperty(ub.n);if(Kb){}if(jsx3.CLASS_LOADER.IE&&jsx3.CLASS_LOADER.getVersion()>10){j.setProperty(ub.n,ub.o+o.getId()+ub.p+m.BE+ub.q);}else j.setProperty(ub.n,ub.r+o.getId()+ub.p+m.BE+ub.s+ub.t+ub.u+o.getId()+ub.p+m.BE+ub.v);return;}var
Ea=j.getProperty(Ta);if(Ea){Eb=Ea.replace(ub.w,ub.x);if(!Ea.match(ub.y))Eb=Eb+ub.z;}Eb=Eb+(ub.u+o.getId()+ub.p+m.BE+ub.A+m.QO+ub.B+f+ub.C);if(Eb.length>0)j.setProperty(Ta,Eb);};m.updateVector=function(g,q){var
X=g.paintDom();if(X!=q&&q.parentNode)q.parentNode.replaceChild(X,q);};});jsx3.Class.defineClass("jsx3.html.Tag",null,null,function(g,q){var
...
Hb=ub.b+ya;if(this.T1!=null&&this.T1.getParent()!=null)(this.T1.getParent()).removeChild(this.T1);this.setProperty(ub.c,ub.d+Hb+ub.e);this.removeProperty(ub.f);this.T1=new
Ea(Sa.Th,ub.g);this.T1.setId(Hb);var
na=this.be.getAngle()||Number(0);var
va=jsx3.util.numMod(2*Math.PI/360*(-1*na-90),2*Math.PI);var
eb=Math.cos(va);var
N=Math.sin(va);var
F=Math.max(Math.abs(eb),Math.abs(N));N=N/F;eb=eb/F;this.T1.setProperty(ub.h,jsx3.util.numRound(0.5-eb/2,1.0E-4),ub.i,jsx3.util.numRound(0.5-N/2,1.0E-4),ub.j,jsx3.util.numRound(0.5+eb/2,1.0E-4),ub.k,jsx3.util.numRound(0.5+N/2,1.0E-4));var
Ib=this.getRotation();if(Ib)this.T1.setProperty(ub.l,ub.m+-Ib+ub.e);var
Jb=new
Ea(Sa.Th,ub.n);Jb.setProperty(ub.o,ub.p,ub.q,this.be.getColorHtml(),ub.r,this.be.getAlpha());this.T1.appendChild(Jb);var
...
U=new
Ea(Sa.Th,ub.n);U.setProperty(ub.o,Ka+ub.u,ub.q,Fa[1]);this.T1.appendChild(U);}}}}var
hb=new
Ea(Sa.Th,ub.n);hb.setProperty(ub.o,ub.v,ub.q,this.be.getColor2Html(),ub.r,this.be.getAlpha2()!=null?this.be.getAlpha2():1);this.T1.appendChild(hb);(this.getDefs()).appendChild(this.T1);}else this.setProperty(ub.c,this.be.getColorHtml(),ub.f,this.be.getAlpha());}else{this.setProperty(ub.c,ub.w);this.removeProperty(ub.f);if(this.T1!=null&&this.T1.getParent()!=null)(this.T1.getParent()).removeChild(this.T1);}if(this.Pj!=null){var
...
R=0;var
mb=Math.sqrt(Math.pow(i-j,2)+Math.pow(p-q,2));if(q>=p){R=360-Math.round(Math.acos((i-j)/mb)*180/Math.PI);}else R=Math.round(Math.acos((i-j)/mb)*180/Math.PI);this.j3=R%360;this.BJ=new
jsx3.html.Text(l);};b.getText=function(){return this.BJ.getText();};b.setText=function(p){this.BJ.setText(p);};b.paintUpdate=function(){if(!this.getProperty(ub.b))if(this.be){this.setProperty(ub.b,this.be.getColorHtml(),ub.c,this.be.getAlpha());}else{var
