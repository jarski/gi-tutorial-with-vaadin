...
fa=this.JH(j.getPath());if(ka){}else{var
I=this.Ny[fa[0]];if(I){I.addItem(j,fa[1]);}else na.warn(mb.a+fa[0]);}var
v=fa[0]+j.getId()+mb.b;this.Ny[v]=j;};p.addItem=function(h){var
v=this.JH(h.getPath());var
_a=this.Ny[v[0]];if(_a){_a.addItem(h,v[1]);}else na.warn(mb.c+v[0]);};p.JH=function(g){var
ga=g.split(mb.b);var
...
Ca=jsx3.amp;e.init=function(q,a){this.DI=q;this.zO=a;};e.attr=function(h){return this.zO.attr(h);};e.getId=function(){return this.DI.getId()+Eb.a+this.attr(Eb.b);};e.getLabel=function(){return this.attr(Eb.c);};e.getImg=function(){var
...
nb=this.zO.attr(Eb.i);if(nb&&Ca.PlugIn.isBindExpr(nb))return Boolean((this.DI.getPlugIn()).eval(Eb.j+nb.substring(1,nb.length-1)+Eb.k));return true;};e.isSelected=function(){var
Jb=this.zO.attr(Eb.l);if(Jb&&Ca.PlugIn.isBindExpr(Jb))return Boolean((this.DI.getPlugIn()).eval(Eb.j+Jb.substring(1,Jb.length-1)+Eb.k));return false;};e.getHotKey=function(){return this.attr(Eb.m);};e.getMenu=function(){return this._parent;};e.getRootMenu=function(){var
